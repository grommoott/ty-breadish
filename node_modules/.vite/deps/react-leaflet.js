...
var Circle2 = createPathComponent(function createCircle({ center, children: _c, ...options }, ctx) {
  const circle = new Circle(center, options);
...
var CircleMarker2 = createPathComponent(function createCircleMarker({ center, children: _c, ...options }, ctx) {
...
var FeatureGroup2 = createPathComponent(function createFeatureGroup({ children: _c, ...options }, ctx) {
  const group = new FeatureGroup([], options);
...
var GeoJSON2 = createPathComponent(function createGeoJSON({ data, ...options }, ctx) {
...
var ImageOverlay2 = createLayerComponent(function createImageOveraly({ bounds, url, ...options }, ctx) {
  const overlay = new ImageOverlay(url, bounds, options);
...
var LayerGroup2 = createLayerComponent(function createLayerGroup({ children: _c, ...options }, ctx) {
  const group = new LayerGroup([], options);
  return createElementObject(group, extendContext(ctx, {
    layerContainer: group
  }));
});
...
var useLayersControlElement = createElementHook(function createLayersControl({ children: _c, ...options }, ctx) {
  const control = new Control.Layers(void 0, void 0, options);
...
var Marker2 = createLayerComponent(function createMarker({ position, ...options }, ctx) {
...
var Polygon2 = createPathComponent(function createPolygon({ positions, ...options }, ctx) {
  const polygon = new Polygon(positions, options);
...
var Polyline2 = createPathComponent(function createPolyline({ positions, ...options }, ctx) {
  const polyline = new Polyline(positions, options);
...
var Popup2 = createOverlayComponent(function createPopup(props, context) {
  const popup = new Popup(props, context.overlayContainer);
...
var Rectangle2 = createPathComponent(function createRectangle({ bounds, ...options }, ctx) {
  const rectangle = new Rectangle(bounds, options);
...
var useSVGOverlayElement = createElementHook(function createSVGOverlay(props, context) {
  ...
  const overlay = new SVGOverlay(container, bounds, options);
...
var SVGOverlay2 = (0, import_react14.forwardRef)(SVGOverlayComponent);

// node_modules/react-leaflet/lib/TileLayer.js
var TileLayer2 = createTileLayerComponent(function createTileLayer({ url, ...options }, context) {
...
var Tooltip2 = createOverlayComponent(function createTooltip(props, context) {
  const tooltip = new Tooltip(props, context.overlayContainer);
...
var VideoOverlay2 = createLayerComponent(function createVideoOverlay({ bounds, url, ...options }, ctx) {
  var _a;
  const overlay = new VideoOverlay(url, bounds, options);
...
export {
  AttributionControl,
  Circle2 as Circle,
  CircleMarker2 as CircleMarker,
  FeatureGroup2 as FeatureGroup,
  GeoJSON2 as GeoJSON,
  ImageOverlay2 as ImageOverlay,
  LayerGroup2 as LayerGroup,
  LayersControl,
  MapContainer,
  Marker2 as Marker,
  Pane,
  ...
  SVGOverlay2 as SVGOverlay,
  ScaleControl,
  TileLayer2 as TileLayer,
  Tooltip2 as Tooltip,
  VideoOverlay2 as VideoOverlay,
  WMSTileLayer,
  ZoomControl,
  useMap,
  useMapEvent,
